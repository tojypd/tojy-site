...
export const HERO_IMAGE = "/public/images/hero/hero_old.jpg";
...
export const TEAM: TeamMember[] = [
  {
    ...
    highlights: [
      ...
      "OBS 신년특집 다큐 <미래를 짓는 집>",
      "OBS <찾아라 마이홈> 시즌 1, 2",
      "JTBC <K-스타일링 배틀 마법옷장> 시즌 1,2",
...
export const WORKS: WorkItem[] = [
  ...
  },
  {
    ...
    description: "전직 조폭 vs 의사 vs 북파공작원, 격투기 예능의 시초",
  },
  {
    id: "w12",
    title: "Get it beauty",
  ...
  },
  {
    ...
    description: "EMMY와 골든로즈 대상 수상에 빛나는 세계 최고의 리얼리티 프로그램의 한국 편",
  },
  {
    id: "w21",
    title: "쏘리맘",
  ...
  },
  {
    ...
    description: "전통있는 미의 향연,미스코리아 선발대회",
  },
  {
    id: "w23",
    title: "문보나 프로젝트",
    ...
    description: "언리얼기반 버추얼 아이돌 쇼 프로젝트",
  },
  {
    id: "w24",
    title: "트라이앵글",
    ...
    description: "역사, 사회, 과학, 심리, 문화, 의학 등 서로 다른 이야기들이 하나의 질문을 따라 이어지는 지식 릴레이 스토리텔링 쇼",
  },
  {
    id: "w25",
    title: "무명전설 디너쇼",
    ...
    description: "초대형 남자 트로트 오디션 프로그램으로 TOP10 전원이 총출동해 특별한 무대를 꾸미는 음악쇼",
  },
  {
    id: "w26",
    title: "쏠 트레블J카드 광고",
    ...
    description: "일본 여행에 꼭 필요한 필수템 쏠트레블J 체크카드 ",
  },
  {
    id: "w27",
    title: "교환왔수다",
    ...
    description: "해외파 올드스쿨 박준형, MZ대표 크리에이터 미미미누가 세대 차이를 뛰어넘어 전국 유망 학과의 대학생활을 체험하는 리얼 캠퍼스 버라이어티!",
  },
  {
    id: "w28",
    title: "이웃집 찰스",
